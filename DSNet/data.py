    ...
    def __init__(self, root_dir, train=True, transform=None, target_transform=None):
        ...
        if self.train:
            ...
            for f in tqdm(os.listdir(self.root_dir+'/train/images')):
                ...
                train_img = cv2.imread( 'temp.jpg' )
                self.train_data.append(train_img)
#                print(train_img)
                target_img = Image.open(self.root_dir+'/train/masks/'+ f[:-5]+'_mask.tiff')
                target_img = target_img.convert("RGB")
                target_img.save( 'temp.jpg')
                target_img = cv2.imread( 'temp.jpg')
...
if __name__ == "__main__":
    prepared_dataset = PrepareDataset(root_dir="/home/pranav/Projects/learning/companies/bowl",
                                     train=True,
